...
class TestSupabaseManagerEmailPasswordAuth:
    ...
    def test_sign_up_with_email_password_success(
        self, supabase_manager, mock_session_storage
    ):
        ...
        result = supabase_manager.sign_up_with_email_password(
    ...
    def test_sign_up_with_email_password_email_exists_error(self, supabase_manager):
        ...
        supabase_manager._client.auth.sign_up.side_effect = Exception(
    ...
    def test_sign_in_with_email_password_success(
        self, supabase_manager, mock_session_storage
    ):
        ...
        result = supabase_manager.sign_in_with_email_password(
            "test@example.com", "password123"
        )
    ...
    def test_sign_in_with_email_password_invalid_credentials_error(
        self, supabase_manager
    ):
        """Test signin with invalid credentials."""
        supabase_manager._client.auth.sign_in_with_password.side_effect = Exception(
            "Invalid credentials"
        )
