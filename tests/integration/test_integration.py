...
from src.presentation.controllers.addition import addition_mode, run_addition_quiz, ProblemGenerator
...
class TestAdditionModeIntegration:
    ...
    def test_addition_mode_complete_flow(self, mocker, capsys):
        ...
        mock_get_user_input = mocker.patch('src.presentation.controllers.addition.get_user_input', side_effect=['1', '2', '3'])
        
        # Mock the quiz function to avoid complex quiz loop
        mock_run_quiz = mocker.patch('src.presentation.controllers.addition.run_addition_quiz', return_value=(2, 3, 45.0))
