...
class TestContainerInit:
    ...
    def test_init_dependency_chain(self, mock_supabase_manager):
        ...
        assert (
            container.user_service.user_repo.supabase_manager == mock_supabase_manager
        )
        assert (
            container.quiz_service.quiz_repo.supabase_manager == mock_supabase_manager
        )
...
class TestContainerDependencyInjection:
    ...
    def test_single_supabase_manager_instance(self, mock_supabase_manager):
        ...
        assert (
            container.user_repository.supabase_manager
            is container.quiz_repository.supabase_manager
        )
...
class TestContainerDocumentation:
    ...
    def test_container_follows_dependency_injection_pattern(
    ...
    def test_container_provides_all_required_services(self, container):
        ...
        required_services = [
            "user_repo",
            "quiz_repo",  # Repository layer
            "user_svc",
            "quiz_svc",  # Service layer
        ]
    ...
    def test_container_maintains_single_responsibility(self, container):
        ...
        for method in container_methods:
            assert (
                method in expected_properties + expected_attributes
