...
class TestMathFactPerformance:
    ...
    def test_update_performance_incorrect(self):
        ...
        assert performance.total_attempts == 1
        assert performance.correct_attempts == 0
        assert performance.average_response_time_ms == 0  # No time tracked for incorrect attempts
    ...
    def test_calculate_sm2_grade_excellent(self):
        ...
        grade = performance.calculate_sm2_grade(response_time_ms=1000, incorrect_attempts=0)
    ...
    def test_calculate_sm2_grade_good(self):
        ...
        grade = performance.calculate_sm2_grade(response_time_ms=2500, incorrect_attempts=0)
    ...
    def test_calculate_sm2_grade_medium(self):
        ...
        grade = performance.calculate_sm2_grade(response_time_ms=4000, incorrect_attempts=0)
    ...
    def test_calculate_sm2_grade_poor(self):
        ...
        grade = performance.calculate_sm2_grade(response_time_ms=8000, incorrect_attempts=2)
    ...
    def test_calculate_sm2_grade_blackout(self):
        ...
        grade = performance.calculate_sm2_grade(response_time_ms=12000, incorrect_attempts=5)
    ...
    def test_sm2_grade_calculation_scenarios(self, response_time, incorrect_attempts, expected_grade):
