...
class TestGetOrCreateUserProfile:
    ...
    def test_get_existing_user_profile(self, user_service, mock_user_repository, sample_user):
    ...
    def test_create_new_user_profile(self, user_service, mock_user_repository, sample_user):
    ...
    def test_create_user_with_default_display_name(self, user_service, mock_user_repository, sample_user):
    ...
    def test_creation_failed_fallback_to_existing(self, user_service, mock_user_repository, sample_user):
        """Test fallback to existing user when creation fails."""
        # Setup
        mock_user_repository.get_user_profile.side_effect = [None, sample_user]  # First call returns None, second returns user
    ...
    def test_creation_failed_no_fallback(self, user_service, mock_user_repository):
        ...
        # Setup
        mock_user_repository.get_user_profile.side_effect = [None, None]  # Both calls return None
        mock_user_repository.create_user_profile.return_value = None  # Creation fails
    ...
    def test_creation_successful_clears_cache(self, user_service, mock_user_repository, sample_user):
...
class TestUpdateDisplayName:
    ...
    def test_update_display_name_success(self, user_service, mock_user_repository, sample_user):
    ...
    def test_update_display_name_user_not_found(self, user_service, mock_user_repository):
        ...
        # Verify
        assert result is None
        mock_user_repository.get_user_profile.assert_called_once_with("nonexistent-user")
        mock_user_repository.update_user_profile.assert_not_called()

    def test_update_display_name_update_fails(self, user_service, mock_user_repository, sample_user):
...
class TestGetCurrentUser:
    ...
    def test_get_current_user_not_authenticated(self, user_service, mock_user_repository):
    ...
    def test_get_current_user_cached_without_force_refresh(self, user_service, mock_user_repository, sample_user):
    ...
    def test_get_current_user_force_refresh_with_profile(self, user_service, mock_user_repository, sample_user, auth_user_response):
    ...
    def test_get_current_user_no_force_refresh_with_profile(self, user_service, mock_user_repository, sample_user, auth_user_response):
    ...
    def test_get_current_user_force_refresh_no_auth_response(self, user_service, mock_user_repository):
    ...
    def test_get_current_user_force_refresh_no_user_in_response(self, user_service, mock_user_repository):
    ...
    def test_get_current_user_no_user_in_session(self, user_service, mock_user_repository):
    ...
    def test_get_current_user_create_profile_from_auth_force_refresh(self, user_service, mock_user_repository, sample_user, auth_user_response):
        ...
        # Verify
        assert result == sample_user
        mock_get_or_create.assert_called_once_with("test-user-123", "test@example.com", "Test User")
        
        # Should cache the result
        assert user_service._cached_user == sample_user
        assert user_service._cached_user_id == "test-user-123"

    def test_get_current_user_create_profile_from_auth_no_force_refresh(self, user_service, mock_user_repository, sample_user, auth_user_response):
    ...
    def test_get_current_user_exception_handling(self, user_service, mock_user_repository):
        """Test get_current_user exception handling."""
        # Setup
        mock_user_repository.supabase_manager.is_authenticated.side_effect = Exception("Test error")
    ...
    def test_get_current_user_force_refresh_different_user_id(self, user_service, mock_user_repository, sample_user, auth_user_response):
        ...
        # Verify
        assert result == sample_user
        mock_user_repository.get_user_profile.assert_called_once_with("different-user-456")
