...
class AdditionFactRepository(BaseRepository):
    ...
    def get_weak_facts(
        ...
        try:
            ...
            weak_facts = [
                ...
                if fact.total_attempts >= min_attempts 
                and fact.accuracy <= max_accuracy
            ]
    ...
    def get_mastered_facts(
        ...
        """
        return self.get_user_fact_performances(
    ...
    def get_performance_summary(self, user_id: str) -> dict:
        ...
        try:
            ...
            mastery_counts = {
                "learning": len([f for f in all_facts if f.mastery_level == MasteryLevel.LEARNING]),
                "practicing": len([f for f in all_facts if f.mastery_level == MasteryLevel.PRACTICING]),
                "mastered": len([f for f in all_facts if f.mastery_level == MasteryLevel.MASTERED])
            }
