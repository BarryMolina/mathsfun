...
class AdditionFactService:
    ...
    def get_weak_facts(
        ...
        """
        return self.fact_repository.get_weak_facts(
    ...
    def get_mastered_facts(
        ...
        """
        return self.fact_repository.get_mastered_facts(user_id, limit)
    ...
    def analyze_session_performance(
        ...
        correct_attempts = sum(1 for _, _, is_correct, _ in session_attempts if is_correct)
        session_accuracy = (correct_attempts / total_attempts) * 100 if total_attempts > 0 else 0
        ...
        for fact in updated_facts:
            if fact.mastery_level == MasteryLevel.MASTERED and fact.total_attempts >= 10:
