...
def get_order_preference() -> bool:
    ...
    while True:
        user_input = get_user_input("Order: 'sequential' or 'random'", "sequential").lower()
        if user_input in ['sequential', 'seq', 's']:
            return False
        elif user_input in ['random', 'rand', 'r']:
            return True
        else:
            print("❌ Please enter 'sequential' or 'random'")
