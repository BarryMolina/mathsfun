...
class UserService:
    ...
    def get_current_user(self, supabase_client, force_refresh: bool = False) -> Optional[User]:
        ...
        try:
            ...
            if not force_refresh and self._cached_user and self._cached_user_id == user_id:
